...
import { registrValidation, loginValidation } from './validations/auth.js'
...
app.get('/my-tickets', checkAuth, (req, res) => {
	UserController.getTickets(req, res, client)
})
...
app.post('/posts', checkAuth, handleValidationErrors, (req, res) => {
...
// 	}
// )
app.listen(process.env.PORT || 44444, err => {
	if (err) {
